    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>Your Best Solution of Healthcare</h1>
          <h2>Kami PT. SRI INTAN PERKASA menyediakan produk-produk radiologi untuk klinik kesehatan, rumah sakit, klinik kedokteran gigi, dan hal-hal yang berkaitan dengan kedokteran radiologi.&nbsp;</h2>
